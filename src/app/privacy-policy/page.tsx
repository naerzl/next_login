  ...
  return (
    <main className="pt-10 px-96 phone:px-4 mx-auto agreement privacy">
      ...
      <div className="px-10 rounded-xl border border-[#ccc] phone:text-xs phone:px-4 mb-3">
        ...
        <p>
          工程数字化管理平台及其对应的App由北京筑宬科技有限公司运营（具体App详情见附录）。
          我们重视用户的隐私，隐私权是您重要的权利。您在使用我们的服务时，我们可能会收集和使用您的相关信息。我们希望通过本《隐私政策》向您说明，在使用我们的服务时，我们如何收集、使用、储存和分享这些信息，以及我们为您提供的访问、更新、控制和保护这些信息的方式。本《隐私政策》与您所使用的系统服务息息相关，希望您仔细阅读，在需要时，按照本《隐私政策》的指引，作出您认为适当的选择。本《隐私政策》中涉及的相关技术词汇，我们尽量以简明扼要的表述，并提供进一步说明的链接，以便您的理解。
        </p>
        <p>本隐私政策仅适用于工程数字化管理平台及对应的APP内有效。</p>
        <p>
          您使用或继续使用我们的服务，即意味着同意我们按照本《隐私政策》收集、使用、储存和分享您的相关信息。
        </p>
        <p>如对本《隐私政策》或相关事宜有任何问题，请通过t@t5x.cn与我们联系。</p>
        <p>
          <strong>
            我们可能收集的信息包括您的手机号，工作单位、项目名称以及你在网站的使用数据。
          </strong>
        </p>
        <p>
        ...
        <p>
          ...
          beacon或其他方式自动采集的技术信息，包括：设备或软件信息，例如您的移动设备、网页浏览器或用于接入我们服务的其他程序所提供的配置信息、您的IP地址和移动设备所用的版本和设备识别码。
        </p>
        <p>
          在使用我们服务时搜索或浏览的信息，例如您使用的网页搜索词语、以及您在使用我们服务时浏览或要求提供的其他信息和内容详情；有关您曾使用的移动应用（APP）和其他软件的信息，以及您曾经使用该等移动应用和软件的信息。
        </p>
        <p>
        ...
        <p>
          3.帮助我们设计新服务，改善我们现有服务；使我们更加了解您如何接入和使用我们的服务，
          {/*从而针对性地回应您的个性化需求，例如语言设定、*/}
          {/*位置设定、个性化的帮助服务和指示，或对您和其他用户作出其他方面的回应；*/}
        </p>
        <p>
          4.
          {/*向您提供与您更加相关的广告以替代普遍投放的广告；评估我们服务中的广告和其他促销及推广活动的效果，并加以改善；*/}
          软件认证或管理软件升级；让您参与有关我们产品和服务的调查。
        </p>
        <p>
          为了让您有更好的体验、改善我们的服务或您同意的其他用途，在符合相关法律法规的前提下，我们可能将通过某一项服务所收集的信息，以汇集信息
          {/*或者个性化*/}
          的方式，用于我们的其他服务。例如，在您使用我们的一项服务时所收集的信息，可能在另一服务中用于向您提供特定内容，或向您展示与您相关的
          {/*、非普遍推送的*/}
          信息。如果我们在相关服务中提供了相应选项，您也可以授权我们将该服务所提供和储存的信息用于我们的其他服务。
        </p>
        <p>您如何访问和控制自己的个人信息 </p>
        <p>
        ...
        <p>3.履行我们在《服务协议》或本《隐私政策》中的义务和行使我们的权利；</p>
        <p>4.理解、维护和改善我们的服务。</p>
        <p>
        ...
        <p>
          我们使用自己的cookies和web beacon，目的是为您提供更优质
          {/*个性化*/}
          的用户体验和服务，并用于以下用途：
        </p>
        <p>
        ...
        <p>
          您可以联系邮箱：business@zctc.cc联系我们注销账号，我们将停止为您提供全部服务，并依据法律法规相关要求通过匿名化等方式处理您的个人信息，或删除与您帐户相关的个人信息，但法律法规或监管机构对用户信息存储时间另有规定的除外。您应当知悉，该注销申请，一旦提交，不可撤销，恢复，您将永久性失去您账户的所有数据的访问权限，我们将在7个工作日内完成您的注销需求。
        </p>
        <p>
          <strong>变更 </strong>
        </p>
        ...
        <p>
          <strong> 我们在您使用服务过程中收集的信息 </strong>
        </p>
        <p>
          <b>• 与您的设备或SIM卡相关的信息：</b>
        ...
        <div>
          <table className="text-sm mb-3">
            <thead>
              <tr>
                <th className="w-20 border">序号</th>
                <th className="w-20 border">App名称</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="w-20 text-center border">1</td>
                <td className="w-20 text-center border">筑宬App</td>
              </tr>
            </tbody>
          </table>
        </div>
