...
export const metadata = {
  title: "服务条款-工程化数字管理系统",
  description: "服务条款-工程化数字管理系统",
}
  ...
  return (
    <main className="pt-10 px-96 agreement">
      ...
      <div className="px-10 rounded-xl border border-[#ccc]">
        ...
        <p>b.对网站服务器进行恶意攻击，或者采取恶意手段使用平台，造成服务器异常；</p>
        <p>c.使用筑宬软件从事非法活动或者为非法活动提供帮助；</p>
        <p>d.法律法规规定的其他情形。</p>
        <p>
        ...
        <p>(3) 未经请求或授权向平台帐户发送大量与业务不相关的信息;</p>
        <p>(4) 冒用其他企业的名义发布商业信息，进行商业活动;</p>
        <p>(5) 攻击平台的数据、网络或服务;</p>
        <p>(6) 盗用他人在平台的帐户名或密码。</p>
        ...
        <p>(3) 对于因甲方员工误操作导致的数据丢失、数据外泄等行为与筑宬软件无关;</p>
        <p>
