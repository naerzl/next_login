...
export default function Login() {
    ...
    //     method: 'get',
    //     data: { oauth_callback: 'http://192.168.2.17:3000/auth' },
    // }
    // const handleLogin = React.useCallback(async () => {
    //   OauthObj.lrsOauthInitiate({request_data,router,url:request_data.url,path:'/'})
    // }, [])
    ...
    React.useEffect(()=>{
        ...
        // OauthObj.lrsOauthInitiate({request_data,router,url:request_data.url,_next:'/ceshi'})
    },[])
    return (
